...
int main() {
    ...
    for (int i = 0; i < maxY; i++) {
        ...
        for (int i = 0; i < 9; i++) {
            mvprintw(maxY / 2 - 4 + i, (maxX - options[i].length()) / 2, "%s", options[i].c_str());
        }
                ...
                while (true) {
                    ...
                    switch (itemChoice) {
                        case 1: {
                            ...
                            std::string bindingType = bindingTypeBuffer;  // Convert to std::string
                            ...
                            std::string publicationDate = publicationDateBuffer;  // Convert to std::string
                        ...
                        case 3: {
                            ...
                            Ebook* newEbook = new Ebook(ebookTitle, ebookAuthor, fileSize, ebookFormat, ebookGenre, ebookPubDate);
